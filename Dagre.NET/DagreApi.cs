...
{
    readonly DagreGraph _graph;
    readonly Dictionary<string, object> _nodeUserData = new(StringComparer.Ordinal);
    readonly Dictionary<(string, string), object> _edgeUserData = new();
