...
public class EdgeLabel : IDictionary<string, object>
{
    ...
    private bool TryGetTyped(string key, out object value)
    {
        switch (key)
        {
            ...
            case "points":
                value = Points;
                return IsSet(F_Points);
            case "weight":
                value = Weight;
                return IsSet(F_Weight);
            case "minlen":
                value = Minlen;
                return IsSet(F_Minlen);
            case "labelpos":
                value = LabelPos;
                return IsSet(F_LabelPos);
            case "labeloffset":
                value = LabelOffset;
                return IsSet(F_LabelOffset);
            case "forwardName":
                value = ForwardName;
                return IsSet(F_ForwardName);
            case "reversed":
                value = Reversed;
                return IsSet(F_Reversed);
            case "cutvalue":
                value = Cutvalue;
