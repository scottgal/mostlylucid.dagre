...
public class NodeLabel : IDictionary<string, object>
{
    ...
    public Dictionary<string, string> BorderLeft
    {
        get => _borderLeft;
        set
        {
    ...
    public Dictionary<string, string> BorderRight
    {
        get => _borderRight;
        set
        {
    ...
    public List<SelfEdgeInfo> SelfEdges
    {
        get => _selfEdges;
        set
        {
    ...
    public object this[string key]
    {
        get => TryGetTyped(key, out var val) ? val :
            _overflow != null && _overflow.TryGetValue(key, out val) ? val : throw new KeyNotFoundException(key);
    ...
    private bool TryGetTyped(string key, out object value)
    {
        switch (key)
        {
            ...
            case "width":
                value = Width;
                return IsSet(F_Width);
            case "height":
                value = Height;
                return IsSet(F_Height);
            case "rank":
                value = Rank;
                return IsSet(F_Rank);
            case "order":
                value = Order;
                return IsSet(F_Order);
            case "minRank":
                value = MinRank;
                return IsSet(F_MinRank);
            case "maxRank":
                value = MaxRank;
                return IsSet(F_MaxRank);
            case "low":
                value = Low;
                return IsSet(F_Low);
            case "lim":
            ...
            case "parent":
                value = Parent;
                return IsSet(F_Parent);
            case "cutvalue":
                value = Cutvalue;
                return IsSet(F_Cutvalue);
            case "dummy":
                value = Dummy;
                return IsSet(F_Dummy);
            case "borderType":
                value = BorderType;
                return IsSet(F_BorderType);
            case "borderTop":
                value = BorderTop;
                return IsSet(F_BorderTop);
            case "borderBottom":
                value = BorderBottom;
                return IsSet(F_BorderBottom);
            case "borderLeft":
                value = BorderLeft;
                return IsSet(F_BorderLeft);
            case "borderRight":
                value = BorderRight;
                return IsSet(F_BorderRight);
            case "root":
                value = Root;
                return IsSet(F_Root);
            case "isGroup":
                value = IsGroup;
                return IsSet(F_IsGroup);
            case "nestingRoot":
                value = NestingRoot;
                return IsSet(F_NestingRoot);
            case "edgeObj":
                value = EdgeObj;
                return IsSet(F_EdgeObj);
            case "edgeLabel":
                value = EdgeLabel;
                return IsSet(F_EdgeLabel);
            case "e":
                value = E;
                return IsSet(F_E);
            case "label":
                value = Label;
                return IsSet(F_Label);
            case "labelRank":
                value = LabelRank;
                return IsSet(F_LabelRank);
            case "labelpos":
                value = LabelPos;
                return IsSet(F_LabelPos);
            case "selfEdges":
                value = SelfEdges;
                return IsSet(F_SelfEdges);
            case "source":
                value = Source;
                return IsSet(F_Source);
            case "nestingEdge":
                value = NestingEdge;
